...
module.exports = {
  ...
  getElementHtml: function getElementHtml(selector) {
    return this.getElement(selector).innerHTML;
  },
  setElementHtml: function setElementHtml(selector, html) {
    this.getElement(selector).innerHTML = html;
  },
  setElementHtmlWithfadeIn: function setElementHtmlWithfadeIn(selector, html) {
    var secs = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 5;
    ...
    setTimeout(function () {
      return element.setAttribute('style', 'transition: ' + secs + 's; opacity: 1;');
    }, delay);
  }
};
...
module.exports = {
  renderStrTemplate: function renderStrTemplate(strTpl) {
...
var ui = __webpack_require__(6);
var templates = __webpack_require__(36);

var buttonsClickListeners = [];

module.exports = {
  render: function render(dest, data) {
    var buttonsHtml = renderButtons(data);
    var buttonsBar = template.renderStrTemplate(templates.barContainer, { buttonsHtml: buttonsHtml });

    ui.setElementHtml(dest, buttonsBar);
    bindButtons(data);
  },
  addBtnCLickListerner: function addBtnCLickListerner(callback) {
    buttonsClickListeners.push(callback);
  }
};

function renderButtons(data) {
  return data.reduce(function (html, button) {
    var idButton = getButtonId(button);
    var buttonHtml = template.renderStrTemplate(templates.button, {
      id: idButton,
      file: button.file,
...
function bindButtons(data) {
  data.forEach(function (button) {
    var buttonSelector = '#' + getButtonId(button);
    ui.getElement(buttonSelector).addEventListener('click', function (event) {
      return doBtnCLickListerners(event.target.dataset);
    });
  });
}
...
function doBtnCLickListerners(event) {
  buttonsClickListeners.forEach(function (callback) {
...
module.exports = {
  connect: function connect() {
    var socket = io('http://' + config.apiHost + ':' + config.apiPort);
    socket.on('connect', function () {
...
function bindEventListeners(socket) {
  eventsListeners.forEach(function (listener) {
    return socket.on(listener.on, listener.handler);
  });
}
...
var news = __webpack_require__(39);
var operators = __webpack_require__(40);
var services = __webpack_require__(41);
var games = __webpack_require__(38);

module.exports = {
  normalize: function normalize(data) {
    var strategy = getStrategy(data.category);
...
module.exports = {
  render: function render(items) {
    var htmlFileElements = renderItems(items);
...
function renderFile(htmlFileElements) {
  return template.renderStrTemplate(templates.fileTpl, { htmlFileElements: htmlFileElements });
}

function renderItems(items) {
  var htmlFile = items.reduce(function (html, item) {
...
function renderTitle(title) {
  return template.renderStrTemplate(templates.titleTpl, { title: title });
}

function renderItem(item) {
  var htmlTitle = renderTitle(item.title);
  var htmlContents = renderContents(item.contents);

  return renderFileContents(htmlTitle, htmlContents);
}

function renderFileContents(intemTitle, intemContents) {
  return template.renderStrTemplate(templates.itemContentsTpl, { intemTitle: intemTitle, intemContents: intemContents });
}

function renderContents(contents) {
  return contents.reduce(function (html, contentsItem) {
    return html + renderContentsItem(contentsItem);
  }, '');
}
...
function renderImage(imageUrl) {
  return template.renderStrTemplate(templates.imageTpl, { imageUrl: imageUrl });
}

function renderLink(linkUrl) {
  return template.renderStrTemplate(templates.linkTpl, { linkUrl: linkUrl });
}

function renderText(text) {
  return template.renderStrTemplate(templates.textTpl, { text: text });
}

function renderDate(date) {
  return template.renderStrTemplate(templates.dateTpl, { date: date });
}
...
var normalizer = __webpack_require__(29);
var renderer = __webpack_require__(31);
var buttonsBar = __webpack_require__(27);
var apiClient = __webpack_require__(28);
var ui = __webpack_require__(6);
var template = __webpack_require__(11);

var styles = __webpack_require__(26);
var templates = __webpack_require__(72);

var elRenderContainer = '#renderer-container';
var elButtonsContainer = '#buttons-container';

var apiEventsListeners = [{
  on: 'buttons',
  handler: gotButtons
}, {
  on: 'file',
...
function init() {
  apiEventsListeners.forEach(function (event) {
    return apiClient.addEventListener(event);
  });
...
function gotFile(data) {
  var fileHtml = fileHasData(data) ? renderer.render(normalizer.normalize(data)) : template.renderStrTemplate(templates.noJsonTpl);
...
module.exports = {
    button: '<div class="button" id="{id}" data-category="{category}" data-file="{file}">{file}</div>',
...
module.exports = {
  normalize: function normalize(json) {
    return Object.keys(json).map(function (game, id) {
      var gameObj = json[game];
      return {
        order: id,
        title: game,
        contents: [{
...
module.exports = {
  normalize: function normalize(json) {
    ...
    return Object.keys(operators).map(function (op, id) {
      var opObj = operators[op];
      return {
        order: id,
        title: op,
        contents: [{
...
module.exports = {
  normalize: function normalize(json) {
    var servicesNorm = json.servicesOrder.map(function (order, id) {
      var title = json.services[id];
      var url = json.servicesUrl[id];
      var textContent = json.servicesDescription[id];
    ...
    return servicesNorm.sort(function (a, b) {
...
module.exports = {
  fileTpl: "<div class=\"elements-container\">\n        {htmlFileElements}\n    </div>",
  itemContentsTpl: "<div class=\"element-container\">\n      <div class=\"title-container\">\n        {intemTitle}\n      </div>\n      <div class=\"contents-container\">\n        {intemContents}\n      </div>\n    </div>",
  titleTpl: "<div class=\"title\">\n      {title}\n    </div>",
  dateTpl: "<div class=\"date-content content\">\n      <div class=\"icon-date\"></div>\n      <div class=\"date\">{date}</div>\n     </div>",
  linkTpl: "<div class=\"link-content content\">\n      <div class=\"icon-link\"></div>\n      <div class=\"link\"><a href=\"{linkUrl}\">{linkUrl}</a></div>\n    </div>",
  textTpl: "<div class=\"text-content content\">\n      {text}\n    </div>",
  imageTpl: "<div class=\"image-content content\">\n      <img src=\"{imageUrl}\"/>\n    </div>"
};
...
// module
exports.push([module.i, "/* Mobile first */\n\nbody {\n    font-family: Helvetica, Arial;\n    color: #444444;\n}\n\n.button-bar {\n    display: flex;\n    margin-left: 15%;\n    margin-right: 15%;\n    flex-wrap: wrap;\n    flex-direction: column;\n}\n\n.button {\n    width: 100px;\n    height: 36px;\n    line-height: 36px;\n    margin: auto;\n    cursor: pointer;\n    text-align: center;\n    font-weight: bold;\n    font-size: 20px;\n    width: 156px;\n}\n\n.button:hover {\n    background-color: steelblue;\n    color: aliceblue;\n}\n\n#buttons-container{\n    margin-top: 60px;\n}\n\n.no-json {\n    margin: auto;\n    font-size: 60px;\n    color: lightgray;\n    font-weight: bolder;\n}\n\n/* Big screens */\n@media only screen and (min-width : 500px) {\n    .button-bar {\n        flex-direction: row;\n    }\n\n    #buttons-container {\n        margin-top: 100px;\n    }\n}\n", ""]);
...
// module
exports.push([module.i, "/* Mobile first */\n\n.icon-date {\n    background-image: url('/src/vendor/thirdpartyrenderer/assets/img/date.png');\n    background-size: 20px;\n    background-repeat: no-repeat;\n    width: 20px;\n}\n\n.icon-link {\n    background-image: url('/src/vendor/thirdpartyrenderer/assets/img/link.png');\n    background-size: 20px;\n    background-repeat: no-repeat;\n    width: 26px;\n}\n\n.link-content {\n    word-wrap: break-word;\n}\n\n.date-content {\n    display: flex;\n}\n\n.link-content {\n    display: flex;\n}\n\n.date {\n    margin-left: 6px;\n}\n\n.link {\n    margin-left: 6px;\n    word-break: break-all;\n    font-size: 14px;\n}\n\n.content {\n    padding: 2px;\n}\n\n.elements-container {\n    display: flex;\n    flex-wrap: wrap;\n    flex-direction: column;\n    justify-content: flex-start;\n}\n\n.element-container {\n    width: 300px;\n    padding: 6px;\n}\n\n.title {\n    font-weight: bold;\n}\n\n#renderer-container{\n    display: flex;\n    margin-left: 10%;\n    margin-right: 10%;\n    margin-top: 48px;\n}\n\n/* Big screens */\n@media only screen and (min-width : 500px) {\n    .elements-container {\n        flex-direction: row;\n        justify-content: flex-start\n    }\n\n    #buttons-container {\n        /*margin-top: 100px;*/\n    }\n}\n", ""]);
...
module.exports = {
  noJsonTpl: "<div class=\"no-json\">\n          NO JSON DATA IN FILE\n    </div>"
};
